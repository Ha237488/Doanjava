...
public class ProductDAO extends DBConnection{
	...
	public void insert(ProductModels product) {
		String sql="insert into Products(name,description,price,promotionalPrice,quantity,sold,is_Active,is_Selling,categoryID,storeID,rating,created_At,updated_At,img) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		try {
			Connection conn= super.getConnection();
			PreparedStatement ps= conn.prepareStatement(sql);
	...
	public void insert(ProductModels product,int id) {
		String sql="insert into Products(name,description,price,promotional_Price,quantity,sold,is_Active,is_Selling,categoryID,storeID,rating,created_At,updated_At,img) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		try {
			Connection conn= super.getConnection();
			PreparedStatement ps= conn.prepareStatement(sql);
	...
	public void edit(ProductModels product) {
		String sql="UPDATE Products SET "
				+ "name=?,img=?, description=?, price=?, promotional_Price=?,"
				+ "is_Active=?, is_Selling=?, categoryId=?,storeId=?,"
				+ "updated_At=? WHERE productID=?";
		try {
			Connection conn=super.getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, product.getProductName());
	...
	{
		String sql = "UPDATE Products SET is_Active='false'  WHERE productID = ?";
		try {
	...
	{
		String sql = "UPDATE Products SET is_Selling='false'  WHERE productID = ?";
		try {
		Connection con = super.getConnection();
		PreparedStatement ps = con.prepareStatement(sql);
		ps.setInt(1, id);
...
String sql="SELECT count(*) FROM Category inner join Products on Category.categoryID=Products.categoryID where Products.storeID=? and Products.categoryID=?";
	...
	public void edit(int id) {
		String sql="UPDATE Products SET is_Active=? WHERE productID=?";
		try {
			Connection conn= super.getConnection();
			PreparedStatement ps=conn.prepareStatement(sql);
