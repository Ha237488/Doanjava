...
public class Theodoi_STDAO extends DBConnection{
	...
	public void theodoi(int userid,int storeid) {
		String sql="INSERT INTO UserFollowStore(userid,storeid,is_Deleted,created_At,updated_At) VALUES (?,?,?,?,?)";
		try {
	...
	{
		String sql = "UPDATE Category SET is_Deleted='true'  WHERE categoryID = ?";
		try {
